		...
		<div id="content">
			<div class="wrapper">
				...
				<div class="post-list-group">
					<h3>Beverage Counters & Cashier Stations</h3>
					<div id="post-list" class="grid-layout">
							<?php 
								...
								$query_args = array(
									...
									'term' => 'beverage-counters-cashier-stations'
								);
				...
				<div class="post-list-group">
					<h3>Tray Slides & Work Shelves</h3>
					<div id="post-list" class="grid-layout">
							<?php 
								$paged = ( get_query_var('paged') ) ? get_query_var('paged') : 1;
								$query_args = array(
