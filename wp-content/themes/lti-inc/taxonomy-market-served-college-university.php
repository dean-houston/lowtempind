	...
	<main id="main" role="main">
		...
		<div id="content">
			<div class="wrapper">
				...
				<h1>Higher Ed Foodservice Case Studies</h1>
				...
				<?php 
					...
					$query_args = array(
						...
						'term' => 'college-university',
						'posts_per_page' => -1,
						'ignore_custom_sort' => true, /* via https://wordpress.stackexchange.com/questions/248993/wp-query-orderby-title-doesnt-work */
						'paged' => $paged
					);
